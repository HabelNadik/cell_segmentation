...
"""
import sys
#sys.path.insert(0, 'C:/Users/bhaladik/mrcnn_development/mask_rcnn/mrcnn')
from mrcnn import former_lambda_layers as fll
...
### try the strange hack to control gpu memory
...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            anchors = fll.AnchorLayer(anchors)(input_image)
        else:
    ...
    def set_log_dir(self, model_path=None):
        ...
        TODO:
        This behavior is not ideal, if the model is heavily used for inference.
        There should be a setting that does not log.
        """
